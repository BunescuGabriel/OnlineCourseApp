...
def submit(request, course_id):
    ...
    return render(request, 'course_detail_bootstrap.html', {'course': course})
    
def exam_form(request, course_id):
    course = get_object_or_404(Course, id=course_id)
    questions = Question.objects.filter(course=course)

    return render(request, 'course_detail_bootstrap.html', {'course': course, 'questions': questions})
...
def show_exam_result(request, course_id, submission_id):
    ...
    for choice_id in selected_choice_ids:
        ...
        if is_correct:
            ...
            total_score += submission.choices.get(id=choice_id).question.grade
